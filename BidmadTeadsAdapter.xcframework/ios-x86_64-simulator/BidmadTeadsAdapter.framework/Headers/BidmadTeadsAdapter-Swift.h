...
#ifndef BIDMADTEADSADAPTER_SWIFT_H
#define BIDMADTEADSADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidmadTeadsAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class TeadsAdRatio;
@class AdFailReason;
@class TeadsAdOpportunityTrackerView;
@class BidmadAdUnit;

SWIFT_CLASS("_TtC18BidmadTeadsAdapter30BidmadInterstitialTeadsAdapter")
...
SWIFT_CLASS("_TtC18BidmadTeadsAdapter24BidmadNativeTeadsAdapter")
@interface BidmadNativeTeadsAdapter : BidmadNativeAdapter <TeadsAdDelegate, TeadsNativeAdPlacementDelegate>
- (void)loadAdWith:(void (^ _Nonnull)(BidmadNativeAdapter * _Nullable, NSError * _Nullable))completionHandler;
- (CGSize)showAdTo:(BIDMADNativeAdView * _Nonnull)adView defaultSize:(CGSize)defaultSize SWIFT_WARN_UNUSED_RESULT;
- (void)removeAdFrom:(BIDMADNativeAdView * _Nonnull)adView;
