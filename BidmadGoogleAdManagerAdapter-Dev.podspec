Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/adop-devel/BidmadSDK-CocoaPods.git', :tag => 'BidmadGoogleAdManagerAdapter-Dev.11.2.0.1' }
  s.static_framework = true
  s.requires_arc     = true
  s.vendored_frameworks = "Dev/BidmadGoogleAdManagerAdapter.xcframework"
  s.swift_version = '5.0'
