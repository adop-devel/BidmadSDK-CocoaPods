...
#if defined(__OBJC__)
typedef SWIFT_ENUM(NSInteger, BIDMADAdPosition, open) {
...
@protocol OBHBannerExtraDelegate;
...
SWIFT_PROTOCOL("_TtP9BidmadSDK22OBHBannerExtraDelegate_")
@protocol OBHBannerExtraDelegate <NSObject>
@property (nonatomic, copy) NSString * _Nonnull zoneID;
- (void)addLoadedAdView:(UIView * _Nonnull)adView adWidth:(CGFloat)adWidth adHeight:(CGFloat)adHeight strategy:(BidmadBannerSizeStrategy)strategy keyWindow:(UIWindow * _Nullable)keyWindow error:(NSError * _Nullable * _Nullable)error;
@end
