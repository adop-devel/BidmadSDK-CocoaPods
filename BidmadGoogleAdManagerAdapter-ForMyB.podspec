Pod::Spec.new do |s|
  ...
  s.name             = "BidmadGoogleAdManagerAdapter-ForMyB"
  ...
  s.source           = { :git => 'https://github.com/adop-devel/BidmadSDK-CocoaPods.git', :tag => 'BidmadGoogleAdManagerAdapter-ForMyB.12.2.0.11.0' }
