...
#ifndef BIDMADMOBWITHADAPTER_SWIFT_H
#define BIDMADMOBWITHADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidmadMobwithAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20BidmadMobwithAdapter26BidmadBannerMobwithAdapter") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface BidmadBannerMobwithAdapter : BidmadBannerAdapter
