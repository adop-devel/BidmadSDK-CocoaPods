...
SWIFT_CLASS("_TtC17OpenBiddingHelper31OpenBiddingFlutterBannerRefined")
...
+ (OpenBiddingFlutterBannerRefined * _Nonnull)sharedWithRegistrar:(NSObject * _Nonnull)registrar chanNm:(NSString * _Nonnull)chanNm SWIFT_WARN_UNUSED_RESULT;
...
@interface OpenBiddingFlutterBannerRefined (SWIFT_EXTENSION(OpenBiddingHelper)) <BIDMADOpenBiddingBannerDelegate>
- (void)onLoadAd:(OpenBiddingBanner * _Nonnull)bidmadAd adWidth:(CGFloat)width adHeight:(CGFloat)height;
...
SWIFT_CLASS("_TtC17OpenBiddingHelper38OpenBiddingFlutterBannerRefinedFactory")
@interface OpenBiddingFlutterBannerRefinedFactory : NSObject <FlutterPlatformViewFactory>
...
SWIFT_CLASS("_TtC17OpenBiddingHelper43OpenBiddingFlutterBannerRefinedPlatformView")
@interface OpenBiddingFlutterBannerRefinedPlatformView : NSObject <FlutterPlatformView>
